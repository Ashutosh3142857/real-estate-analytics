...
def show_ad_performance_analytics():
    """Show ad performance analytics by importing from the dedicated module."""
    from pages.ad_performance_analytics import show_ad_performance_analytics as show_analytics
    show_analytics()
